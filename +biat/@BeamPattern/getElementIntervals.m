        ...
        switch obj.Type
            ...
            case 'polygonal'
                ...
                if isnumeric(AcI)
                    ...
                    for n = 1:N
                        for m = 1:M
                            if obj.HasProbability
                                polarInt = ciat.PolarInterval( r_I(m,n), ph_I(m,n) );
                                polarInt.ProbaGrid = ciat.ProbaGrid(polarInt, obj.ErrorDistribution);
                                value(m,n) = ciat.PolygonalInterval( polarInt, ...
                                                'tolerance',tolerance ) ;
                            else
                    ...
                    for n = 1:N
                        for m = 1:M
                            ...
                            if obj.HasProbability
                                EcI.ProbaGrid = ciat.ProbaGrid(EcI, obj.ErrorDistribution);
                                AcI(m,n).ProbaGrid = ciat.ProbaGrid(AcI(m,n), obj.CouplingErrorDistribution);
                            end
