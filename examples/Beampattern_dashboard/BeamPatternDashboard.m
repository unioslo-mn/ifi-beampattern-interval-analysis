...
gui.pos.dY = 0.07;
gui.pos.textPos = [0,0.99,0.16,0.06]; 
gui.pos.ctrlPos = [0.16,0.99,0.24,0.06];
gui.pos.valPos = [0.40,0.99,0.08,0.06];

%   Slider: Number of elements
gui.pos.textPos(2)=gui.pos.textPos(2)-gui.pos.dY; gui.pos.ctrlPos(2)=gui.pos.ctrlPos(2)-gui.pos.dY; gui.pos.valPos(2)=gui.pos.valPos(2)-gui.pos.dY;

gui.text.Nel = uicontrol('Style','text',...
                'String','N_element',...
                'Parent',gui.uip1,...
                'Units','normalized',...
                'Position',gui.pos.textPos);
gui.ctrl.Nel = uicontrol( 'Style', 'slider',...
                'Parent',gui.uip1,...
                'Units','normalized',...
                'Position',gui.pos.ctrlPos,...
                'Min',2,...
                'Max',22,...
                'SliderStep',[0.05,0.1],...
...
% Initialize position variables
gui.pos.dY = 0.07;
gui.pos.textPos = [0.5,0.99,0.16,0.06]; 
gui.pos.ctrlPos = [0.66,0.99,0.24,0.06];
gui.pos.valPos = [0.90,0.99,0.08,0.06];

%   Slider: Gain error
gui.pos.textPos(2)=gui.pos.textPos(2)-gui.pos.dY; 
gui.pos.ctrlPos(2)=gui.pos.ctrlPos(2)-gui.pos.dY; 
gui.pos.valPos(2)=gui.pos.valPos(2)-gui.pos.dY;
...
% Initialize position variables
gui.pos.dY = 0.055;
gui.pos.tbPos = [0.34,0.98,0.36,0.055];

% Add checkboxes
gui.pos.tbPos(2)=gui.pos.tbPos(2) - gui.pos.dY;
gui.tb.N = uicontrol('Style','checkbox',...
                'Units','normalized',...
                'Position',gui.pos.tbPos,...
                'Parent',gui.uip2,...
                'Value',gui.plt.sel(1),...
                'Callback',@cbTbN);
gui.pos.tbPos(2)=gui.pos.tbPos(2) - gui.pos.dY;
...
gui.tb.C = uicontrol('Style','checkbox',...
                ...
                'Callback',@cbTbC);
gui.pos.tbPos(2)=gui.pos.tbPos(2) - gui.pos.dY;
gui.tb.M = uicontrol('Style','checkbox',...
                'Units','normalized',...
                'Position',gui.pos.tbPos,...
                'Parent',gui.uip2,...
                'Value',gui.plt.sel(4),...
                'Callback',@cbTbM);
gui.tb = [gui.tb.N;gui.tb.R;gui.tb.C;gui.tb.M];
