...
D_Hu = sum(P_Hu.width,1) / sum(P_nom);
...
annotText = {   'Phase error',...
                ...
                ['\color[rgb]{' num2str(cList(2,:)) '}' ...
                    '\Delta^{(c)}=' num2str(100*D_x(2)/D_c(2),3) '%']};
annotation('textbox',[0.33 0.42 .11 0.5],'String',annotText, ...
           'BackgroundColor','w',...
           'HorizontalAlignment','center','FitBoxToText','on');
    % Calibration errors
annotText = {   'Both errors',...
                ...
                ['\color[rgb]{' num2str(cList(2,:)) '}' ...
                    '\Delta^{(c)}=' num2str(100*D_x(3)/D_c(3),3) '%']};
annotation('textbox',[0.61 0.42 .11 0.5],'String',annotText, ...
           'BackgroundColor','w',...
           'HorizontalAlignment','center','FitBoxToText','on');
    % Mutual coupling 
annotText = {   'Errors & coupling',...
                ...
                ['\color[rgb]{' num2str(cList(1,:)) '}' ...
                    '\Delta^{(r)}=' num2str(100*D_x(4)/D_r(4),3) '%'],...
                ['\color[rgb]{' num2str(cList(2,:)) '}' ...
                    '\Delta^{(c)}=' num2str(100*D_x(4)/D_c(4),3) '%'],...
                ['\color[rgb]{' num2str(cList(3,:)) '}' ...
                    '\Delta^{(M)}=' num2str(100*D_x(4)/D_Sc,3) '%'],...
                ['\color[rgb]{' num2str(cList(4,:)) '}' ...
                    '\Delta^{(C)}=' num2str(100*D_x(4)/D_An,3) '%']};
annotation('textbox',[0.76 0.42 .12 0.5],'String',annotText, ...
           'BackgroundColor','w',...
           'HorizontalAlignment','center','FitBoxToText','on');
