...
text(real(A.Center)-0.05,imag(A.Center), '$p_m$',...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(A.Center),imag(A.Center)+0.05, '$R_m$',...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(Ap(1).Center),imag(Ap(1).Center)-0.03, ...
    '$A_m^I \underline{a}_m e^{j\underline{\varphi}_m}$',...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(Ap(2).Center),imag(Ap(2).Center)-0.05, ...
    '$A_m^I \overline{a}_m e^{j\underline{\varphi}_m}$',...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(Ap(3).Center),imag(Ap(3).Center)-0.05, ...
    '$A_m^I \underline{a}_m e^{j\overline{\varphi}_m}$',...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(Ap(4).Center),imag(Ap(4).Center)+0.03, ...
    '$A_m^I \overline{a}_m e^{j\overline{\varphi}_m}$',...
    'HorizontalAlignment','center','Interpreter','latex')
...
text(real(pnt),imag(pnt), '$E^I_m$', ...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(pnt)-0.02,imag(pnt)+0.1, '$a^I_m$', ...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(pnt)+0.15,imag(pnt)+0.02, '$\varphi^I_m$', ...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(Ecorn(1)),imag(Ecorn(1))+0.03, ...
    '$\underline{a}_m e^{j\underline{\varphi}_m}$', ...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(Ecorn(2)),imag(Ecorn(2))+0.03, ...
    '$\overline{a}_m e^{j\underline{\varphi}_m}$', ...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(Ecorn(3)),imag(Ecorn(3))+0.03, ...
    '$\underline{a}_m e^{j\overline{\varphi}_m}$', ...
    'HorizontalAlignment','center','Interpreter','latex')
text(real(Ecorn(4)),imag(Ecorn(4))+0.03, ...
    '$\overline{a}_m e^{j\overline{\varphi}_m}$', ...
    'HorizontalAlignment','center','Interpreter','latex')
...
text(real(pnt),imag(pnt), '$E^I_m p_m$', ...
    'HorizontalAlignment','center','Interpreter','latex')
